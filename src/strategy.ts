...
export const hard: ReadonlyArray<Plays | undefined>[] = [];
// Dealer      2    3    4    5    6    7    8    9    10   A
hard[2]  = [,,'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H'];
hard[3]  = [,,'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H', 'H'];
...
export const soft: ReadonlyArray<Plays | undefined>[] = []; // A+2 = soft[2], A+3 = soft[3]
// Dealer      2    3    4    5    6    7    8    9    10   A
...
soft[7] =  [,,'D', 'D', 'D', 'D', 'D', 'S', 'S', 'H', 'H', 'S'];
soft[8] =  [,,'S', 'S', 'S', 'S', 'D', 'S', 'S', 'S', 'S', 'S'];
soft[9] =  [,,'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S'];
soft[10] = [,,'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S', 'S'];

export const pairs: ReadonlyArray<Plays | undefined>[] = []; // 2+2 = pairs[2], 3+3 = pairs[3]
// Dealer       2    3    4    5    6    7    8    9    10   A
pairs[2]  = [,,'H', 'T', 'T', 'T', 'T', 'T', 'H', 'H', 'H', 'H'];
pairs[3]  = [,,'H', 'H', 'T', 'T', 'T', 'T', 'H', 'H', 'H', 'H'];
pairs[4]  = [,,'H', 'H', 'H', 'D', 'D', 'H', 'H', 'H', 'H', 'H'];
pairs[5]  = [,,'D', 'D', 'D', 'D', 'D', 'D', 'D', 'D', 'H', 'H'];
pairs[6]  = [,,'T', 'T', 'T', 'T', 'T', 'H', 'H', 'H', 'H', 'H'];
pairs[7]  = [,,'T', 'T', 'T', 'T', 'T', 'T', 'H', 'H', 'S', 'H'];
